...
function Library:CreateWindow(options)
    ...
    Header.BackgroundColor3 = Library.Theme.Header; Header.BorderSizePixel = 0; Header.Size = UDim2.new(1, 0, 0, 45)
    ...
    local Logo = Instance.new("Frame", Header); Logo.BackgroundTransparency = 1; Logo.Position = UDim2.new(0, 15, 0, 0); Logo.Size = UDim2.new(0, 150, 1, 0)
    local L1 = Instance.new("TextLabel", Logo); L1.BackgroundTransparency = 1; L1.Size = UDim2.new(0, 0, 1, 0); L1.Font = Library.Theme.Font; L1.Text = "Keta"; L1.TextColor3 = Library.Theme.Text; L1.TextSize = 17; L1.TextXAlignment = Enum.TextXAlignment.Left; L1.AutomaticSize = Enum.AutomaticSize.X
    local L2 = Instance.new("TextLabel", Logo); L2.BackgroundTransparency = 1; L2.Position = UDim2.new(0, 36, 0, 0); L2.Size = UDim2.new(0, 0, 1, 0); L2.Font = Library.Theme.Font; L2.Text = "mine"; L2.TextColor3 = Library.Theme.Accent; L2.TextSize = 17; L2.TextXAlignment = Enum.TextXAlignment.Left; L2.AutomaticSize = Enum.AutomaticSize.X

    local TabContainer = Instance.new("Frame", Header); TabContainer.BackgroundTransparency = 1; TabContainer.Position = UDim2.new(1, -350, 0, 0); TabContainer.Size = UDim2.new(0, 340, 1, 0)
    ...
    local SubHeader = Instance.new("Frame", Main); SubHeader.BackgroundColor3 = Library.Theme.SubHeader; SubHeader.BorderSizePixel = 0; SubHeader.Position = UDim2.new(0, 0, 0, 45); SubHeader.Size = UDim2.new(1, 0, 0, 30)
    ...
    local Content = Instance.new("Frame", Main); Content.BackgroundTransparency = 1; Content.Position = UDim2.new(0, 0, 0, 75); Content.Size = UDim2.new(1, 0, 1, -75)
    ...
    function Window:CreateTab(name)
        ...
        local PagePadding = Instance.new("UIPadding", Page); PagePadding.PaddingLeft = UDim.new(0, 15); PagePadding.PaddingRight = UDim.new(0, 15); PagePadding.PaddingTop = UDim.new(0, 15)
