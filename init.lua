...
Library.Theme = {
    ...
    TextInactive = Color3.fromRGB(160, 160, 180), -- Increased visibility
...
function Library:CreateWindow(options)
    ...
    Header.BackgroundColor3 = Library.Theme.Header; Header.BorderSizePixel = 0; Header.Size = UDim2.new(1, 0, 0, 50) -- Increased height slightly
    ...
    -- SubHeader (Tab Info)
    local SubHeader = Instance.new("Frame", Main); SubHeader.BackgroundColor3 = Library.Theme.SubHeader; SubHeader.BorderSizePixel = 0; SubHeader.Position = UDim2.new(0, 0, 0, 50); SubHeader.Size = UDim2.new(1, 0, 0, 35)
    ...
    -- Content
    local Content = Instance.new("Frame", Main); Content.BackgroundTransparency = 1; Content.Position = UDim2.new(0, 0, 0, 85); Content.Size = UDim2.new(1, 0, 1, -85)
    ...
    function Window:CreateTab(name)
        ...
        function Tab:CreateSection(title)
            ...
            local STitle = Instance.new("TextLabel", SectionFrame); STitle.BackgroundTransparency = 1; STitle.Position = UDim2.new(0, 12, 0, 10); STitle.Size = UDim2.new(1, -24, 0, 20); STitle.Font = Library.Theme.Font; STitle.Text = title; STitle.TextColor3 = Library.Theme.Text; STitle.TextSize = 13; STitle.TextXAlignment = Enum.TextXAlignment.Left
            
            local Container = Instance.new("Frame", SectionFrame); Container.BackgroundTransparency = 1; Container.Position = UDim2.new(0, 0, 0, 35); Container.Size = UDim2.new(1, 0, 0, 0); Container.AutomaticSize = Enum.AutomaticSize.Y
            local CLayout = Instance.new("UIListLayout", Container); CLayout.Padding = UDim.new(0, 10); CLayout.HorizontalAlignment = Enum.HorizontalAlignment.Center
            ...
            function Section:CreateToggle(text, default, callback)
                ...
                local Label = Instance.new("TextLabel", Tgl); Label.BackgroundTransparency = 1; Label.Position = UDim2.new(0, 26, 0, 0); Label.Size = UDim2.new(1, -26, 1, 0); Label.Font = Library.Theme.Font; Label.Text = text; Label.TextColor3 = state and Library.Theme.Text or Library.Theme.TextInactive; Label.TextSize = 14; Label.TextXAlignment = Enum.TextXAlignment.Left
            ...
            function Section:CreateSlider(text, min, max, default, callback)
                local Sld = Instance.new("Frame", Container); Sld.BackgroundTransparency = 1; Sld.Size = UDim2.new(0, 230, 0, 40)
                local Label = Instance.new("TextLabel", Sld); Label.BackgroundTransparency = 1; Label.Size = UDim2.new(1, 0, 0, 18); Label.Font = Library.Theme.Font; Label.Text = text; Label.TextColor3 = Library.Theme.TextInactive; Label.TextSize = 13; Label.TextXAlignment = Enum.TextXAlignment.Left
                local ValLabel = Instance.new("TextLabel", Sld); ValLabel.BackgroundTransparency = 1; ValLabel.Position = UDim2.new(1, -50, 0, 0); ValLabel.Size = UDim2.new(0, 50, 0, 18); ValLabel.Font = Library.Theme.Font; ValLabel.Text = tostring(default); ValLabel.TextColor3 = Library.Theme.TextInactive; ValLabel.TextSize = 13; ValLabel.TextXAlignment = Enum.TextXAlignment.Right
                local Bar = Instance.new("Frame", Sld); Bar.BackgroundColor3 = Library.Theme.Main; Bar.BorderSizePixel = 0; Bar.Position = UDim2.new(0, 0, 0, 25); Bar.Size = UDim2.new(1, 0, 0, 8)
