...
function Library:CreateWindow(options)
    ...
    function Window:CreateTab(name)
        ...
        function Tab:CreateSection(title)
            local SectionFrame = Instance.new("Frame", Page); SectionFrame.BackgroundColor3 = Library.Theme.Child; SectionFrame.BorderSizePixel = 0; SectionFrame.AutomaticSize = Enum.AutomaticSize.Y; SectionFrame.Size = UDim2.new(1, 0, 0, 0); SectionFrame.ZIndex = 2
            ...
            local STitle = Instance.new("TextLabel", SectionFrame); STitle.BackgroundTransparency = 1; STitle.Position = UDim2.new(0, 12, 0, 12); STitle.Size = UDim2.new(1, -24, 0, 20); STitle.Font = Library.Theme.Font; STitle.Text = title; STitle.TextColor3 = Library.Theme.Text; STitle.TextSize = 13; STitle.TextXAlignment = Enum.TextXAlignment.Left; STitle.ZIndex = 3
            
            local Container = Instance.new("Frame", SectionFrame); Container.BackgroundTransparency = 1; Container.Position = UDim2.new(0, 0, 0, 38); Container.Size = UDim2.new(1, 0, 0, 0); Container.AutomaticSize = Enum.AutomaticSize.Y; Container.ZIndex = 2
            ...
            function Section:CreateToggle(text, default, callback)
                ...
                local Tgl = Instance.new("TextButton", Container); Tgl.BackgroundTransparency = 1; Tgl.Size = UDim2.new(0, 230, 0, 22); Tgl.Text = ""; Tgl.ZIndex = 3
                local Box = Instance.new("Frame", Tgl); Box.BackgroundColor3 = state and Library.Theme.Accent or Library.Theme.Main; Box.BorderSizePixel = 0; Box.Size = UDim2.new(0, 16, 0, 16); Box.Position = UDim2.new(0, 0, 0.5, -8); Box.ZIndex = 4
                Instance.new("UICorner", Box).CornerRadius = UDim.new(0, 4)
                local Label = Instance.new("TextLabel", Tgl); Label.BackgroundTransparency = 1; Label.Position = UDim2.new(0, 28, 0, 0); Label.Size = UDim2.new(1, -28, 1, 0); Label.Font = Library.Theme.Font; Label.Text = text; Label.TextColor3 = state and Library.Theme.Text or Library.Theme.TextInactive; Label.TextSize = 14; Label.TextXAlignment = Enum.TextXAlignment.Left; Label.ZIndex = 4
            ...
            function Section:CreateSlider(text, min, max, default, callback)
                local Sld = Instance.new("Frame", Container); Sld.BackgroundTransparency = 1; Sld.Size = UDim2.new(0, 230, 0, 45); Sld.ZIndex = 3
                local Label = Instance.new("TextLabel", Sld); Label.BackgroundTransparency = 1; Label.Size = UDim2.new(1, 0, 0, 20); Label.Font = Library.Theme.Font; Label.Text = text; Label.TextColor3 = Library.Theme.TextInactive; Label.TextSize = 13; Label.TextXAlignment = Enum.TextXAlignment.Left; Label.ZIndex = 4
                local ValLabel = Instance.new("TextLabel", Sld); ValLabel.BackgroundTransparency = 1; ValLabel.Position = UDim2.new(1, -50, 0, 0); ValLabel.Size = UDim2.new(0, 50, 0, 20); ValLabel.Font = Library.Theme.Font; ValLabel.Text = tostring(default); ValLabel.TextColor3 = Library.Theme.TextInactive; ValLabel.TextSize = 13; ValLabel.TextXAlignment = Enum.TextXAlignment.Right; ValLabel.ZIndex = 4
                local Bar = Instance.new("Frame", Sld); Bar.BackgroundColor3 = Library.Theme.Main; Bar.BorderSizePixel = 0; Bar.Position = UDim2.new(0, 0, 0, 28); Bar.Size = UDim2.new(1, 0, 0, 8); Bar.ZIndex = 4
                Instance.new("UICorner", Bar).CornerRadius = UDim.new(0, 4)
                local Fill = Instance.new("Frame", Bar); Fill.BackgroundColor3 = Library.Theme.Accent; Fill.BorderSizePixel = 0; Fill.Size = UDim2.new((default - min) / (max - min), 0, 1, 0); Fill.ZIndex = 5
