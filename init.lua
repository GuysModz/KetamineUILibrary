...
function Library:MakeDraggable(drag_part, target_part)
	...
	drag_part.InputBegan:Connect(function(input)
		if (input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch) and not game:GetService("GuiService"):GetGuiSelectedItem() then
